...
(() => {
    ...
    $('#calendario .container').innerHTML = `${titulo('Calendario', 'Programá tus rutinas y registrá las sesiones realizadas.')}
        ...
        <div class="calendario-app col-12 col-lg-8 mx-auto"><div class="calendario-header text-center fw-semibold text-primary mb-2"><span>Lun</span><span>Mar</span><span>Mié</span><span>Jue</span><span>Vie</span><span>Sáb</span><span>Dom</span></div><div id="dias" class="calendario-grid"></div>
